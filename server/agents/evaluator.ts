...
export const DEFAULT_EVALUATOR_PROMPT = `Eres un OBSERVADOR DE COMPETENCIAS para ScenarioX, una plataforma de entrenamiento en toma de decisiones experiencial.
