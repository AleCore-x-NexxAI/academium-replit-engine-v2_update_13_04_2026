...
export const DEFAULT_NARRATOR_PROMPT = `Eres el NARRADOR DE CONSECUENCIAS para ScenarioX, una plataforma de entrenamiento en toma de decisiones experiencial.
