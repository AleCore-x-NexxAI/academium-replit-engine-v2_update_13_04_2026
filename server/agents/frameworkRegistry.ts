...
export const FRAMEWORK_REGISTRY: FrameworkRegistryEntry[] = [
  ...
  },
  {
    ...
    recognitionSignals_en: [
      "tracing margin gains or losses stage by stage from inbound logistics through after-sales service",
      "tagging activities along the production / delivery sequence as value-creating or value-destroying",
      "diagnosing how the output of one activity-link constrains or enables the next link",
      "identifying which primary or support activity is the binding margin bottleneck",
    ],
    recognitionSignals_es: [
      "rastrear ganancias o pérdidas de margen etapa por etapa, desde logística de entrada hasta servicio postventa",
      "etiquetar actividades a lo largo de la secuencia de producción / entrega como creadoras o destructoras de valor",
      "diagnosticar cómo el resultado de una actividad-eslabón restringe o habilita el siguiente eslabón",
      "identificar qué actividad primaria o de apoyo es el cuello de botella vinculante del margen",
    ],
