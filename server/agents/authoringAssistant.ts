...
const SCENARIO_ARCHITECT_PROMPT = `You are a MASTER SCENARIO ARCHITECT for ScenarioX - an AI-powered business simulation platform for MBA education.
...
const REFINEMENT_ASSISTANT_PROMPT = `You are a SCENARIO REFINEMENT ASSISTANT for ScenarioX. You help professors improve their AI-generated scenarios through conversation.
